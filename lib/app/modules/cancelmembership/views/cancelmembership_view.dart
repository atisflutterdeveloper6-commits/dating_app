          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    final sub =
                        controller.subscription.value ?? controller.defaultData;

                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _infoRow("Plan", sub.planName.isNotEmpty ? sub.planName : "Premium Plus"),
                        _infoRow("Billing Cycle", "Monthly"),
                        _infoRow(
                          "Amount",
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: "Share your thoughts to help us improve...",
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      "Your membership will remain active until the end of the current billing cycle. You won't be charged again.",
                      style: GoogleFonts.poppins(
                        fontSize: 12.sp,
                        color: const Color(0xff666666),
                        height: 1.4,
            ...
            Obx(
              () => SizedBox(
                ...
                child: ElevatedButton(
                  onPressed:
                      controller.isCancelling.value ? null : _showConfirmDialog,
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xffFF6B00),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(30.r),
